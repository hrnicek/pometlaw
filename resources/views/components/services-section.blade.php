    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white rounded border border-gray-20 p-8 text-center">
                ...
                <p class="text-gray-50 mb-6">Školení a kurzy pro administrativní pracovníky, podnikatele a manažery v oblasti veřejných zakázek.</p>
            ...
            <div class="bg-white rounded border border-gray-20 p-8 text-center">
                ...
                <p class="text-gray-50 mb-6">Analýza stávajících procesů a doporučení pro jejich zjednodušení a optimalizaci.</p>
            ...
            <div class="bg-white rounded border border-gray-20 p-8 text-center">
                ...
                <p class="text-gray-50 mb-6">Digitální dokumenty, návody a šablony pro snadnější práci s veřejnými zakázkami.</p>
                <a href="#"
                   class="inline-flex items-center px-6 py-3 bg-delft-blue text-white font-medium rounded">
                    Stáhnout
                    <svg class="ml-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
