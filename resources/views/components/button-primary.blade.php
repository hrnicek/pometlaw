...
@php
  ...
  $baseClasses =
      'inline-flex items-center justify-center text-center bg-delft-blue text-white focus:outline-none focus:ring-2 focus:ring-delft-blue focus:ring-offset-2';
