<section class="py-20 lg:py-32 bg-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8">
            ...
            <div class="group bg-white rounded-3xl p-8 border border-gray-20 hover:border-moonstone flex flex-col h-full">
                <div class="w-16 h-16 rounded-2xl bg-moonstone/10 text-moonstone group-hover:bg-moonstone group-hover:text-white flex items-center justify-center mb-8">
                ...
                <a href="{{ route('events.index') }}" class="inline-flex items-center font-medium text-delft-blue group-hover:text-moonstone">
                    Zobrazit kurzy
            ...
            <div class="group bg-white rounded-3xl p-8 border border-gray-20 hover:border-delft-blue flex flex-col h-full">
                <div class="w-16 h-16 rounded-2xl bg-delft-blue/10 text-delft-blue group-hover:bg-delft-blue group-hover:text-white flex items-center justify-center mb-8">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('contact') }}" class="inline-flex items-center font-medium text-delft-blue group-hover:text-moonstone">
                    Kontaktovat
                    <svg class="ml-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                    </svg>
            ...
            <div class="group bg-white rounded-3xl p-8 border border-gray-20 hover:border-paynes-gray flex flex-col h-full">
                <div class="w-16 h-16 rounded-2xl bg-paynes-gray/10 text-paynes-gray group-hover:bg-paynes-gray group-hover:text-white flex items-center justify-center mb-8">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="group bg-white rounded-3xl p-8 border border-gray-20 hover:border-delft-blue flex flex-col h-full">
                <div class="w-16 h-16 rounded-2xl bg-gray-10 text-gray-75 group-hover:bg-delft-blue group-hover:text-white flex items-center justify-center mb-8">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                    </svg>
                </div>
                ...
                <a href="#" class="inline-flex items-center font-medium text-delft-blue group-hover:text-moonstone">
                    Procházet
                    <svg class="ml-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                    </svg>
