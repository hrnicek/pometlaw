<section class="p-4 bg-white md:p-8">
  <div class="rounded-3xl bg-[#2b3756] pt-16 pb-24 px-6 xs:px-10 xl:px-16 overflow-hidden relative shadow-xl">
    
    <div class="absolute top-0 right-0 w-[600px] h-[600px] bg-[#4A6A82] opacity-10 blur-3xl rounded-full -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>

    <div class="container mx-auto relative z-10">
      
      <div class="flex items-center mb-6 space-x-3">
        <div class="flex items-center justify-center w-2 h-2 rounded-full bg-[#65999B] shadow-[0_0_8px_#65999B]"></div>
        <span class="text-xs font-bold tracking-widest text-[#65999B] uppercase">Naše řešení</span>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
        ...
        <a href="{{ route('events.index') }}" class="group relative flex flex-col h-full p-8 rounded-2xl border border-white/10 bg-white/[0.02] hover:bg-[#2b3756] hover:border-[#65999B] transition-all duration-300 shadow-sm hover:shadow-[0_0_30px_rgba(101,153,155,0.15)]">
          
          <div class="mb-8 inline-flex items-center justify-center w-14 h-14 rounded-xl bg-white/5 border border-white/5 text-white group-hover:text-[#65999B] group-hover:scale-110 group-hover:bg-[#65999B]/10 group-hover:border-[#65999B]/20 transition-all duration-300">
          ...
          <h3 class="text-2xl font-medium text-white mb-4 group-hover:text-[#65999B] transition-colors">Veřejná správa</h3>
          ...
          <div class="flex items-center text-white/40 font-medium text-sm mt-auto group-hover:text-[#65999B] transition-colors">
            <span class="mr-2">Více informací</span>
            <svg class="w-5 h-5 transform group-hover:translate-x-2 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="{{ route('events.index') }}" class="group relative flex flex-col h-full p-8 rounded-2xl border border-white/10 bg-white/[0.02] hover:bg-[#2b3756] hover:border-[#65999B] transition-all duration-300 shadow-sm hover:shadow-[0_0_30px_rgba(101,153,155,0.15)]">
          ...
          <h3 class="text-2xl font-medium text-white mb-4 group-hover:text-[#65999B] transition-colors">Administrativa</h3>
          <p class="text-white/60 text-base leading-relaxed mb-10 flex-grow">
        ...
        <a href="{{ route('events.index') }}" class="group relative flex flex-col h-full p-8 rounded-2xl border border-white/10 bg-white/[0.02] hover:bg-[#2b3756] hover:border-[#65999B] transition-all duration-300 shadow-sm hover:shadow-[0_0_30px_rgba(101,153,155,0.15)]">
          ...
          <h3 class="text-2xl font-medium text-white mb-4 group-hover:text-[#65999B] transition-colors">Podnikatelé</h3>
          <p class="text-white/60 text-base leading-relaxed mb-10 flex-grow">
