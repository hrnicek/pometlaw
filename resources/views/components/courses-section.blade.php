        ...
        @if($events->count() > 0)
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach($events as $event)
                    <div class="bg-white rounded border border-gray-20 overflow-hidden">
                        <div class="p-6">
                                    ...
                                    @if($event->lecturers->count() > 0)
                                        <div class="flex -space-x-2">
                                            @foreach($event->lecturers->take(2) as $lecturer)
                                                ...
                                                @else
                                                    <div class="w-8 h-8 rounded bg-delft-blue border-2 border-white flex items-center justify-center">
