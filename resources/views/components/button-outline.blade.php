...
@php
    ...
    $baseClasses = 'inline-flex items-center justify-center text-center border-2 border-delft-blue text-delft-blue bg-transparent focus:outline-none focus:ring-2 focus:ring-delft-blue focus:ring-offset-2';
