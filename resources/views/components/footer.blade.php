<footer class="bg-white text-gray-900 py-12">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="md:col-span-2">
                ...
                <p class="text-gray-900 mb-6 max-w-md">
                    ...
                    Odstraňujeme zbytečné složitosti a přinášíme jednoduchost a transparentnost.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ route('home') }}" class="text-gray-900">Domů</a></li>
                    <li><a href="#about" class="text-gray-900">O nás</a></li>
                    <li><a href="{{ route('events.index') }}" class="text-gray-900">Školení</a></li>
                    <li><a href="{{ route('contact') }}" class="text-gray-900">Kontakt</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="space-y-3">
                    <div class="flex items-start space-x-3">
                        <svg class="w-5 h-5 text-delft-blue mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Bottom Bar -->
        <div class="border-t border-gray-20 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-900 text-sm">
                © {{ date('Y') }} Pometlaw. Všechna práva vyhrazena.
            </p>
            <div class="flex space-x-6 mt-4 md:mt-0">
                <a href="#" class="text-gray-900 text-sm">Obchodní podmínky</a>
                <a href="#" class="text-gray-900 text-sm">Ochrana osobních údajů</a>
                <a href="#" class="text-gray-900 text-sm">Cookies</a>
            </div>
        </div>
    </div>
</footer>