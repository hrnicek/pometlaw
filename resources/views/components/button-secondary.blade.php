...
@php
    ...
    $baseClasses = 'inline-flex items-center justify-center text-center bg-paynes-gray text-white focus:outline-none focus:ring-2 focus:ring-paynes-gray focus:ring-offset-2';
    
    $disabledClasses = $disabled ? 'opacity-50 cursor-not-allowed' : 'active:bg-paynes-gray/95';
